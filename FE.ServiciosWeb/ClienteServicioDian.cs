...
namespace FE.ServiciosWeb
{
    public class ClienteServicioDian
    {
        ...
        public ClienteServicioDian(AmbienteServicio ambiente, string rutaCertificado, string claveCertificado)
        {
            Ambiente = ambiente;
        ...
        public WcfDianCustomerServicesClient ObtenerClienteServicio()
        {
            ...
            client.ClientCredentials.ClientCertificate.Certificate = Certificado ?? new X509Certificate2(RutaCertificado, ClaveCertificado);
        ...
        public EventResponse[] EnviarEvento(byte[] xmlFirmado)
        {
            var client = ObtenerClienteServicio();
