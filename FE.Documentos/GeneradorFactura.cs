...
namespace FE.Documentos
{
    public class GeneradorFactura
    {
        ...
        public GeneradorFactura(AmbienteDestino ambiente, TipoFactura tipo)
        {
            ...
            Invoice.ProfileID = new ProfileIDType { Value = "DIAN 2.1" };
        ...
        public GeneradorFactura ConAdquiriente(Adquiriente adquiriente)
        {
            Invoice.AccountingCustomerParty = new CustomerPartyType[]
            {
                new CustomerPartyType
                {
                    ...
                    Party = new PartyType
                    {
                        PartyIdentification = (adquiriente.TipoContribuyente == "1") ? null : new PartyIdentificationType[]//1 es persona jurídica
                        {
        ...
        public GeneradorFactura ConDetallesEntrega(DetallesEntrega entrega)
        {
            Invoice.Delivery = new DeliveryType[]
            {
                new DeliveryType
                {
                    ...
                    {
                        PartyIdentification = entrega.Transportador.TipoContribuyente == "1" ? null : new PartyIdentificationType[]//1 es persona jurídica
                        {
                            new PartyIdentificationType
                            {
                                ID = new IDType
