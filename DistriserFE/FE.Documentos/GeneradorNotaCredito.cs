...
namespace FE.Documentos
{
    public class GeneradorNotaCredito
    {
        ...
        public GeneradorNotaCredito(string ambiente, ConceptoNotaCredito concepto, ReferenciaDocumento referencia)
        {
            ...
            CreditNote.ProfileExecutionID = new ProfileExecutionIDType { Value = ambiente };
                ...
                Party = new PartyType
                {
                    ...
                    PartyTaxScheme = new PartyTaxSchemeType[]
                    {
                        new PartyTaxSchemeType
                        {
                            ...
                            {
                                listName = emisor.RegimenFiscal,
                                Value = emisor.ResponsabilidadFiscal
                            },
            ...
            CreditNote.AccountingCustomerParty = new CustomerPartyType[]
            {
                new CustomerPartyType
                {
                    AdditionalAccountID = new AdditionalAccountIDType[]
                    {
                        ...
                        {
                            schemeAgencyID = "195",
                            Value = adquiriente.TipoContribuyente
                        }
                    },
                    Party = new PartyType
                    {
                        PartyIdentification = adquiriente.TipoContribuyente == "1" ? null : new PartyIdentificationType[]
                        {
                            new PartyIdentificationType
                            {
                                ID = new IDType
                                {
                                    schemeAgencyName = "CO, DIAN (Dirección de Impuestos y Aduanas Nacionales)",
                                    schemeAgencyID = "195",
                                    schemeName = adquiriente.TipoIdentificacion,
                        ...
                        PartyTaxScheme = new PartyTaxSchemeType[]
                        {
                            new PartyTaxSchemeType
                            {
                                ...
                                TaxLevelCode = new TaxLevelCodeType
                                {
                                    listName = adquiriente.RegimenFiscal,
                                    Value = adquiriente.ResponsabilidadFiscal
                                },
                                TaxScheme = new TaxSchemeType
                                {
                                    ID = new IDType { Value = TipoImpuesto.IVA.Codigo },
        ...
        public GeneradorNotaCredito ConDetallesEntrega(DetallesEntrega entrega)
        {
            CreditNote.Delivery = new DeliveryType[]
            {
                new DeliveryType
                {
                    ...
                    {
                        PartyIdentification = entrega.Transportador.TipoContribuyente == "1" ? null : new PartyIdentificationType[]
                        {
                            new PartyIdentificationType
                            {
                                ID = new IDType
                                {
                                    schemeAgencyName = "CO, DIAN (Dirección de Impuestos y Aduanas Nacionales)",
                                    schemeAgencyID = "195",
                                    schemeName = entrega.Transportador.TipoIdentificacion,
                        ...
                        PartyTaxScheme = new PartyTaxSchemeType[]
                        {
                            new PartyTaxSchemeType
                            {
                                ...
                                {
                                    listName = "05",
                                    Value = entrega.Transportador.ResponsabilidadFiscal
                                },
                                TaxScheme = new TaxSchemeType
                                {
                                    ID = new IDType { Value = TipoImpuesto.IVA.Codigo },
